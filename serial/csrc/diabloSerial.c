...
#include "zerynth.h"
#include "zwrappers.h"
// TODO: handle timeout with TimeLimit4D
...
extern char *Error4DText[] = {"OK", "Timeout", "NAK", "Length", "Invalid"} ;
// 4D Global variables
...
#else
int ZOpenComm(int drv, int newrate) {
    cPort = drv;
    return vhalSerialInit(drv, newrate, SERIAL_CFG(SERIAL_PARITY_NONE,SERIAL_STOP_ONE, SERIAL_BITS_8,0,0), VM_RXPIN(drv), VM_TXPIN(drv));
}
#endif
void CloseComm(void)
{
